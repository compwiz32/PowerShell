Function Get-DNSServerPerDHCPScope {
<#
.SYNOPSIS
    The Get-DNSServerPerDHCPScope advanced function determines the DNS Servers being used by a DHCP Scope.

.DESCRIPTION
    The Get-DNSServerPerDHCPScope advanced function determines the DNS Servers being used by a DHCP Scope whether the DNS Servers are assigned by the Scope Options, or Server Options.
...
.EXAMPLE
    Get-DNSServerPerDHCPScope -ComputerName 'dhcpsrv1.mydomain.com' | Format-Table -AutoSize
...
.NOTES
    NAME: Get-DNSServerPerDHCPScope
